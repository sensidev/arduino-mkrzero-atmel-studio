...
typedef void (*ModbusMasterCallback)();
...
class ModbusMaster
{
  public:
    ...
    void idle(ModbusMasterCallback f);
    void preTransmission(ModbusMasterCallback f);
    void postTransmission(ModbusMasterCallback f);
  ...
  protected:
    ...
    ModbusMasterCallback _idle;
    // preTransmission callback function; gets called before writing a Modbus message
    ModbusMasterCallback _preTransmission;
    // postTransmission callback function; gets called after a Modbus message has been sent
    ModbusMasterCallback _postTransmission;
};
#endif
