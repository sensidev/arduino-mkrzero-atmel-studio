...
*/
void ModbusMaster::idle(ModbusMasterCallback f)
{
  _idle = f;
}
...
*/
void ModbusMaster::preTransmission(ModbusMasterCallback f)
{
  _preTransmission = f;
}
...
*/
void ModbusMaster::postTransmission(ModbusMasterCallback f)
{
  _postTransmission = f;
}
